    ...
    <header className="fixed top-0 left-0 right-0 h-[100px] bg-header z-20 flex items-center justify-center">
      ...
      <nav className="w-[1200px] h-full grid grid-cols-3 items-center">
        ...
        <div className="flex justify-end">
          <button className="font-semibold text-background px-8 py-4 rounded-lg mr-4 hover:bg-secondary" onClick={() => router.push("/login")}>
            Log In
          </button>
          <button className="font-semibold bg-primary text-background px-8 py-4 rounded-xl hover:bg-secondary" onClick={() => router.push("/signup")}>
            Sign Up
          </button>
        </div>
      </nav>
