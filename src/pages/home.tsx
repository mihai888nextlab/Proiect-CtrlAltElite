    ...
    <div>
      ...
      <main className="min-h-screen bg-background pt-32">
        ...
        <div className="items-center justify-center flex flex-row">
          <div className="min-h-20 w-2/5 mx-6 my-10 mt=20 bg-gradient-to-r from-primary to-secondary rounded-xl border-header border-0">
            <p className="font-semibold text-5xl my-5 text-center text-background">Why Join Social Sync?</p>

          </div>
          <div className="w-2/5 min-h-20 mx-6 bg-gradient-to-r from-secondary to-header rounded-xl border-header border-0">
            <p className="font-semibold text-5xl my-5 text-center text-background">Ready to Connect?</p>
          </div>
        </div>
        <div className="items-center justify-center flex flex-row">
          <div className="w-2/5 my-5 mx-6 h-[30rem] bg-gradient-to-r  from-primary to-secondary rounded-xl border-header border-0">
          ...
          <div className="w-2/5 my-5 mx-6 h-[30rem] bg-gradient-to-r from-secondary to-header rounded-xl border-header border-0">
        ...
        <div className="items-center justify-center flex flex-row">
          <button className="w-1/5 min-h-20 my-24 mx-6 bg-gradient-to-r from-header via-secondary to-header rounded-xl text-3xl hover:from-secondary hover:via-header hover:to-secondary border-secondary border-2 font-semibold text-background px-8 py-4 rounded-xl hover:bg-secondary" onClick={() => router.push("/signup")}>
            Sign Up
          </button>
          <button className="w-1/5 min-h-20 my-24 mx-6 bg-gradient-to-r from-header via-secondary to-header rounded-xl text-3xl hover:from-secondary hover:via-header hover:to-secondary border-secondary border-2 font-semibold text-background px-8 py-4 rounded-xl hover:bg-secondary" onClick={() => router.push("/login")}>
            Log In
          </button>
        </div>
      </main>
