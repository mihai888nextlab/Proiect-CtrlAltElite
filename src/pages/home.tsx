  ...
  return (
    <div>
      ...
      <main className="min-h-screen bg-background pt-32">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto my-8 md:h-screen lg:py-0 max-h-96 w-10/12 bg-gradient-to-r from-primary via-secondary to-header rounded-xl border-header border-0">
        ...
        <div className="items-center justify-center flex flex-row">
          <div className="min-h-20 w-2/5 mx-6 bg-gradient-to-r from-primary to-secondary rounded-xl border-header border-0">
            <p className="text-5xl my-3 text-center text-background">How Social Sync Works</p>

          </div>
          <div className="w-2/5 min-h-20 my-5 mx-6 bg-gradient-to-r from-secondary to-header rounded-xl border-header border-0">
            <p className="text-5xl my-3 text-center text-background">Our Mission</p>
          </div>
        </div>
      </main>
    </div>
